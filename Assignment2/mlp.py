...
class MLP():
    ...
    def backup(self, GDparams, experiment="test_gradients"):
        ...
        np.save(
            f'History/{experiment}_layers_{epochs}_{batch_size}_{eta_min}_{eta_max}_{ns}_{self.lamda}_{self.seed}.npy', self.layers)
        ...
        np.save(
            f'History/{experiment}_hist_{epochs}_{batch_size}_{eta_min}_{eta_max}_{ns}_{self.lamda}_{self.seed}.npy', hist)
